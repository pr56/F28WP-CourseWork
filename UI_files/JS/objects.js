//This part of the code depicts at which position the character originally starts and displays the character's image as it's calling the function
...
//Creates the character moving in the x direction and y direction 
...
// moves the character while keys are pressed down by the user
        this.keys = {
            left: "ArrowLeft",
            right: "ArrowRight",
            up: "ArrowUp",
...
//Event handler that displays the character movement while keys are pressed down. 
// Used "false" or else character will be moving on its own
    handleKeys(event) {
...
// This part of the code updates the character's position everytime the game is refreshed 
    update() {
    ...
    //Character's visual effect when the keys are pressed down. 
    //Use flipped function as a reflective image of the character moving towards the opposite direction
    set_animation() {

/* The general game object w/ collision Detection */
class GameObject {
    constructor(master, x, y, w, h) { // save the canvas object
        this.master = master; // Set coordinates
        this.x = x || 0;
        this.y = y || 0;
        this.w = w || 0;
        this.h = h || 0;
    }
    // Quick access to all four coordinates of the object
    ...
    // dt is the time we want to simulate in a single step
    update(dt) {
        throw "You have to implement the update method before use."
    }
...
/* This will hold multiple game objects. Used to ease collision
    ...
    function wrapper() {
        ...
        if (warning && 1000/(frame_end - prev_frame_end) < 0.9*FPS) {
            ...
            console.warn("Animation error.",
                        " managable FPS is", 1000/(frame_end - prev_frame_end));
        }
